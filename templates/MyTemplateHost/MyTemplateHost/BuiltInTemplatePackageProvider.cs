...
// copied from: https://github.com/dotnet/sdk/blob/main/src/Cli/dotnet/commands/dotnet-new/BuiltInTemplatePackageProvider.cs
...
#pragma warning restore CS0067
    ...
    private static IEnumerable<string> GetTemplateFolders(IEngineEnvironmentSettings environmentSettings)
    {
        ...
        var sdkDirectory = Path.GetDirectoryName(typeof(Microsoft.TemplateEngine.Core.CommonOperations).Assembly.Location);
    ...
    private static IList<string> GetBestVersionsByMajorMinor(IReadOnlyDictionary<string, SemanticVersion> versionDirInfo)
    {
        ...
        Version sdkVersion = typeof(Microsoft.TemplateEngine.Core.CommonOperations).Assembly.GetName().Version;
